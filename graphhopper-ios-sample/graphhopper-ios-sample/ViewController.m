...
@property (nonatomic) Directions *directions;
...
//        view.image = ((MBXPointAnnotation *)annotation).image;
    ...
    {
        static NSString *MKPointStyleReuseIdentifier = @"MKPointStyleReuseIdentifier";
        MKAnnotationView *view = [mapView dequeueReusableAnnotationViewWithIdentifier:MKPointStyleReuseIdentifier];
        if (!view)
        {
            view  = [[MKPinAnnotationView alloc] initWithAnnotation:annotation reuseIdentifier:MKPointStyleReuseIdentifier];
        }
        view.canShowCallout = YES;
